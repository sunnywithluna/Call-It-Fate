label school_day01:
    ...
    scene anna_intro with dissolve
    ...
    scene maddie_intro with dissolve
    ...
    show maddie_1 normal with dissolve
    ...
    hide maddie_1 with dissolve
    show anna_1 uncomf with dissolve
    ...
    scene erin_intro with dissolve
    ...
    scene bg_class_after with dissolve
...
label ch1_weekend:
    ...
    if date_this_weekend:
        ...
        if eventba_trigger and not maddie_date:
            jump maddie_date
        elif eventbb_trigger and not anna_date:
            jump anna_date 
        elif eventbc_trigger and not erin_date:
            jump erin_date
    else: 
